...
### Table View:
Provides the view of various KPIs per device path. This table provides details about the impressions, revenue,
purchases, cost and ROAS for a given device path over a specified timeframe.
image::../images/quicksight-images/device_exposure/device_exposure_tabular_view.png[DeviceExpTabularView]

### Users per Device Path View:
Provides ROAS, Cost and Purchases KPIs for users per device path
image::../images/quicksight-images/device_exposure/device_exposure_kpi_view.png[DeviceExpKPIsView]

### New to Brand purchases and Unique Detail Page Views per Device Path View:
Provides details of new to brand purchases and detail page view across various device path combinations
(PC, PC and Phone, Phone and Tablet, Phone etc.).
image::../images/quicksight-images/device_exposure/device_exposure_ntb_view.png[DeviceExpNTBView]
...
### Graphs across specified date range:
ROAS by region per Campaign (Choose the campaign from the table to analyze per campaign)
image::../images/quicksight-images/geo_analysis/geo_analysis_region_view.png[GeoAnalysisRegionView]

### Impression and ROAS over Revenue:
image::../images/quicksight-images/geo_analysis/geo_analysis_roas_by_city.png[GeoAnalysisRoasByCity]
image::../images/quicksight-images/geo_analysis/geo_analysis_roas_by_city.png[GeoAnalysisRoasByDMA]

### Table View:
Provides the view of various KPIs per campaign, DMA, device type, conversion event subtype and City.
This table provides details about the impressions, revenue, purchases, cost and ROAS for a given campaign
over a specified timeframe.
image::../images/quicksight-images/geo_analysis/geo_analysis_tabular_view.png[GeoAnalysisTabularView]
...
### Table View:
This visual provides tabular view of key performance indicators for a specific given
image::../images/quicksight-images/product_mix/product_mix_tabular_view.png[ProductMixTabular]

### Total Users and User conversions per product mix view:
This visual provides details of total users exposed to DSP, SP and both DSP and SP campaigns and the total user conversions
image::../images/quicksight-images/product_mix/product_mix_reach_view.png[ProductMixReach]

### New to brand purchases and non-converted user view:
This first pie chart provides details on New to brand purchases made by the user exposed to DSP, SP and both DSP and
SP and second provides details on how many users did not get converted when exposed to either DSP, SP and both.
image::../images/quicksight-images/product_mix/product_mix_ntb_view.png[ProductMixNTB]
